...
/// 이벤트 다이얼로그 구현
class MVOMSEventDialog3 extends StatefulWidget {
  const MVOMSEventDialog3({super.key, required this.readOnly, required this.title, this.evntId});
  ...
  @override
  State<MVOMSEventDialog3> createState() => _MVOMSEventDialog3State();
}

class _MVOMSEventDialog3State extends State<MVOMSEventDialog3> with InputWidget {
