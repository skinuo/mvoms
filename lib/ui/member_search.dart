...
class MemberSearch extends StatefulWidget {
  ...
  const MemberSearch({super.key, required this.searchFunc});

  @override
  State<StatefulWidget> createState() => _MemberSearchState();
}

class _MemberSearchState extends State<MemberSearch> with InputWidget {
  // 검색 키워드
  String keyword = "";
